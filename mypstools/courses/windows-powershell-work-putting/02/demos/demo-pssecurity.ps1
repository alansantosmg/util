...
Get-WinEvent -ListLog * -ComputerName localhost -Credential company\administrator
...
cls
Get-WinEvent -FilterHashtable @{Logname = 'Microsoft-Windows-PowerShell/Operational';ID=4100} -MaxEvents 5 | Select-Object -ExpandProperty Message |  more
Show-EventLog
cls
#endregion
